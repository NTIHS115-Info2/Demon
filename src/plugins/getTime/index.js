...
// 建立記錄器
const logger = new Logger('getTime');
...
module.exports = {
  ...
  async updateStrategy(newMode = 'local', options = {}) {
    ...
    logger.info(`getTime 已切換為 ${mode} 模式`);
  },
  ...
  async online(options = {}) {
    ...
    try {
      ...
      logger.error('getTime online 錯誤: ' + e.message);
      throw e;
    }
  },
  ...
  async offline() {
    ...
    try {
      ...
      logger.error('getTime offline 錯誤: ' + e.message);
      throw e;
    }
  },
  ...
  async restart(options = {}) {
    ...
    try {
      ...
      logger.error('getTime restart 錯誤: ' + e.message);
      throw e;
    }
  },
  ...
  async state() {
    ...
    try {
      ...
      logger.error('getTime state 查詢錯誤: ' + e.message);
      return -1;
    }
  },
  ...
  async send(data = {}) {
    ...
    try {
      ...
      logger.error('getTime send 錯誤: ' + e.message);
