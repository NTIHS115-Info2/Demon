...
<!-- 段落說明：紀錄 v1.5.3.7 版本的更新摘要 -->
# [v.1.5.3.7]
<!-- 段落說明：說明此次更新為新功能項目 -->
### New
<!-- 段落說明：摘要新增 iotVisionTurret 與 IoT/視覺能力 -->
<!-- 段落說明：描述 iotVisionTurret 插件與更新紀錄新增 -->
- 新增 iotVisionTurret 插件，建立 IoT 視覺塔台整合能力並新增專屬更新紀錄
<!-- 段落說明：描述 IoT 長輪詢機制用途 -->
- 新增 IoT 長輪詢機制，維持設備狀態同步與事件推送穩定性
<!-- 段落說明：說明 YOLOv11 訓練與推理流程設計 -->
- 新增 YOLOv11 訓練與推理流程設計，涵蓋資料準備、模型管理與推論規劃
<!-- 段落說明：說明格點掃描與粗追蹤功能設計 -->
- 新增格點掃描與粗追蹤功能設計，提升目標搜尋與鎖定效率

# [v.1.5.3.8]
### Fix
- 修復前段更新無法運行的問題，並微調小惡魔
